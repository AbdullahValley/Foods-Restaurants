            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ action('FoodCourtController@update', $food_court->unique_id)  }}"
                            ...
                            <span class="section">Food Court</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sub_location_name">Sub Location Name
                                </label>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Food Court Name <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" value="{{ $food_court->name }}" class="form-control col-md-7 col-xs-12" name="name" required="required" type="text">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="display_name" value="{{ $food_court->display_name }}" required="required"  class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" required="required" name="details" class="form-control col-md-7 col-xs-12">{{ $food_court->details }}</textarea>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <img src="{{ $food_court->avatar ? asset(config('appconfig.imagePath') . $food_court->avatar) : asset('image/avatar.png') }}"
                                         alt="Food Court Image" width="80px;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="active">
                                        ...
                                        <input type="radio" class="flat" id="active" name="status" value="1"
                                               ...
                                               required="required" {{ $food_court->status == 1 ? 'checked' : '' }}>
                                        Active
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inactive">
                                        ...
                                        <input type="radio" class="flat" id="inactive" name="status" value="0"
                                               class="form-control col-md-7 col-xs-12"
                                               required="required" {{ $food_court->status == 0 ? 'checked' : '' }}>
                                        Inactive
