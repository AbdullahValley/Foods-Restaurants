     ...
     <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Food Group <small>sub title</small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ action('FoodGroupController@store') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
                                @csrf
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Food Group Name <span class="required">*</span>
                                    </label>
