    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Food News <small>Some examples to get you started</small></h3>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Food News<small>Users</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            @foreach($food_news as $food_news)
                                <tr>
                                    <td>{{ $sl++ }}</td>
                                    <td>{{ $food_news->title }}</td>
                                    <td>{{ $food_news->description }}</td>
                                    <td>

                                        <img src="{{ $food_news->photo ? asset(config('appconfig.imagePath') . $food_news->photo) : asset('image/avatar.png') }}" alt="Review Image" width="80px;">

                                    </td>

                                    <td>{{ $food_news->featured ? "Yes" : "No" }}</td>
                                    <td>{{ $food_news->status ? "Active" : "Inactive" }}</td>
                                    <td>
