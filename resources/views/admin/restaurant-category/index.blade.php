                            ...
                            @foreach($restaurant_categories as $restaurant_category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ action('RestaurantTypeController@edit', $restaurant_category->unique_id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                                        <form action="{{ action('RestaurantTypeController@destroy', $restaurant_category->unique_id) }}" method="post" style="display: inline">
                                            @csrf
                                            {{ method_field('DELETE') }}
