            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ action('RestaurantNewsController@update', $restaurant_news->unique_id)  }}"
                            ...
                            <span class="section">Restaurant News</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">News Title <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" value="{{ $restaurant_news->title }}" class="form-control col-md-7 col-xs-12" name="title" required="required" type="text">
                                    @if($errors->has('title')) <span class="text-danger">{{ $errors->first('title') }}</span> @endif
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">News Slug <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="slug" value="{{ $restaurant_news->slug }}" required="required"  class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" required="required" name="description" class="form-control col-md-7 col-xs-12">{{ $restaurant_news->description }}</textarea>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <img src="{{ $restaurant_news->photo ? asset(config('appconfig.imagePath') . $restaurant_news->photo) : asset('image/avatar.png') }}"
                                         alt="News Image" width="80px;">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" name="video" class="form-control col-md-7 col-xs-12" placeholder="Youtube Embed Code or URL">{{ $restaurant_news->video }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="checkbox" name="featured" class="form-control col-md-7 col-xs-12 flat" {{ $restaurant_news->featured == 1 ? 'checked' : '' }}>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="active">
                                        ...
                                        <input type="radio" class="flat" id="active" name="status" value="1"
                                               ...
                                               required="required" {{ $restaurant_news->status == 1 ? 'checked' : '' }}>
                                        Active
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inactive">
                                        ...
                                        <input type="radio" class="flat" id="inactive" name="status" value="0"
                                               class="form-control col-md-7 col-xs-12"
                                               required="required" {{ $restaurant_news->status == 0 ? 'checked' : '' }}>
                                        Inactive
