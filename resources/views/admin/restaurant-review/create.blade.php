     ...
     <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Restaurant Review <small>sub title</small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ action('RestaurantReviewController@store') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
                                @csrf
