                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ action('RestaurantTypeController@update', $restaurant_type->unique_id)  }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="name"
                                           value="{{ $restaurant_type->name }}" required="required" type="text">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="email" name="display_name"
                                           value="{{ $restaurant_type->display_name }}" required="required"
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Full Address
                                    <span class="required"></span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" required="required" name="details"
                                              class="form-control col-md-7 col-xs-12">{{ $restaurant_type->details }}</textarea>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <img src="{{ $restaurant_type->avatar ? asset(config('appconfig.imagePath') . $restaurant_type->avatar) : asset('image/avatar.png') }}"
                                         alt="User Image" width="80px;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="active">
                                        ...
                                        <input type="radio" class="flat" id="active" name="status" value="1"
                                               class="form-control col-md-7 col-xs-12"
                                               required="required" {{ $restaurant_type->status == 1 ? 'checked' : '' }}>
                                        Active
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inactive">
                                        ...
                                        <input type="radio" class="flat" id="inactive" name="status" value="0"
                                               class="form-control col-md-7 col-xs-12"
                                               required="required" {{ $restaurant_type->status == 0 ? 'checked' : '' }}>
                                        Inactive
