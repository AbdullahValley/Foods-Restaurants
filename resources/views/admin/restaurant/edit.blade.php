            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ action('RestaurantController@update', $restaurant->unique_id)  }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="name" value="{{ $restaurant->name }}" type="text">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12"  value="{{ $restaurant->display_name }}" name="display_name" required="required" type="text">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" required="required" name="details" class="form-control col-md-7 col-xs-12">{{ $restaurant->details }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" id="email" name="email" value="{{ $restaurant->email }}" class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="tel" id="telephone" value="{{ $restaurant->phone }}" name="phone" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="capacity" value="{{ $restaurant->capacity }}" required="required"  class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="commission_rate">Restaurant Commission Rate %
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="commission_rate" value="{{ $restaurant->commission_rate }}" class="form-control col-md-7 col-xs-12">
                                    @if($errors->has('commission_rate')) <span class="text-danger">{{ $errors->first('commission_rate') }}</span> @endif
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" name="pros" class="form-control col-md-7 col-xs-12">{{ $restaurant->pros }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" name="cons" class="form-control col-md-7 col-xs-12">{{ $restaurant->cons }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" name="our_opinion" class="form-control col-md-7 col-xs-12">{{ $restaurant->our_opinion }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ $restaurant->competitors }}" name="competitors" class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <img src="{{ $restaurant->photo ? asset(config('appconfig.imagePath') . $restaurant->photo) : asset('image/avatar.png') }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" name="video" class="form-control col-md-7 col-xs-12" placeholder="Youtube Embed Code or URL">{{ $restaurant->video }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="rating" value="{{ $restaurant->rating }}" class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="checkbox" name="featured" class="form-control col-md-7 col-xs-12 flat" {{ $restaurant->featured == 1 ? 'checked' : '' }}>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="active">
                                        ...
                                        <input type="radio" class="flat" id="active" name="status" value="1"
                                               ...
                                               required="required" {{ $restaurant->status == 1 ? 'checked' : '' }}>
                                        Active
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inactive">
                                        ...
                                        <input type="radio" class="flat" id="inactive" name="status" value="0"
                                               class="form-control col-md-7 col-xs-12"
                                               required="required" {{ $restaurant->status == 0 ? 'checked' : '' }}>
                                        Inactive
