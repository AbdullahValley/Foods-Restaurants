            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ action('UserController@update', $user->id)  }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="username" value="{{ $user->username }}" required="required" type="text">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="tel" id="telephone" name="phone" value="{{ $user->phone }}" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="textarea" required="required" name="address" class="form-control col-md-7 col-xs-12">{{ $user->address }}</textarea>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    @foreach($roles as $key => $role)
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="{{ $role }}">
                                            ...
                                            <input type="radio" class="flat" id="{{ $role }}" name="role" value="{{ $key }}" class="form-control col-md-7 col-xs-12" required="required" {{ $user->role == $key ? 'checked' : '' }}> {{ $role }}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="active">
                                        ...
                                        <input type="radio" class="flat" id="active" name="status" value="1" class="form-control col-md-7 col-xs-12" required="required" {{ $user->status == 1 ? 'checked' : '' }}> Active

                                    </label>

                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inactive">

                                        <input type="radio" class="flat" id="inactive" name="status" value="0" class="form-control col-md-7 col-xs-12" required="required" {{ $user->status == 0 ? 'checked' : '' }}> Inactive
