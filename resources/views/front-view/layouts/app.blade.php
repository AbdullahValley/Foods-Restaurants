    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 featured-responsive">
                ...
                <div class="featured-place-wrap">
                    <a href="{{ url('/restaurants/'.$restaurant->unique_id) }}">
                        <img src="{{ $restaurant->photo ? asset('uploads/image/'.$restaurant->photo) : asset('uploads/image/default-restaurant.png') }}" class="img-fluid" alt="#">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add Your Restaurant</h5>
